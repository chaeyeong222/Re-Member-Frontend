...
import { Search, Users, Calendar, Eye, Edit, Trash2, Plus, Heart, Star, ArrowLeft } from "lucide-react"
                    ...
                    <Link key={customer.customerKey} href={`/customer/${customer.customerKey}`}>
                      <div className="bg-gradient-to-r from-white to-rose-50/30 rounded-lg border border-rose-100 p-4 hover:shadow-md transition-all cursor-pointer">
                        ...
                        <div className="flex items-center justify-between">
                          ...
                          {/*      <span key={index} className="inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-rose-100 text-rose-700">*/}
                          {/*  {tag}*/}
                          {/*</span>*/}
                          {/*  ))}*/}
