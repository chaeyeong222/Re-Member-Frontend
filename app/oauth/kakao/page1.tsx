        ...
        const handleCallback = async () => {
            ...
            try {
                ...
                if (!tokenResponse.ok) {
                    ...
                    throw new Error("토큰 획득 실패: 서버 응답 " + errorMessage);
                }
                ...
                if (!userResponse.ok) {
                    ...
                    throw new Error("사용자 정보 조회 실패: 서버 응답 " + errorMessage);
                }
                ...
                if (!memberCheckResponse.ok) {
                    const errorMessage = await memberCheckResponse.text();
                    throw new Error("회원 확인 실패: 서버 응답 " + errorMessage);
                }
